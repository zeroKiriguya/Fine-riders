...
window.FINE_DEFAULT_DATA = {
  ...
  merch: {
    ...
    featureDescription:
      "Black heavyweight hoodie with purple FR graphics, sleeve branding, relaxed fit, and color options matching the crew identity.",
  ...
  orders: {
    email: "zero.tipping@gmail.com",
    endpoint: "https://script.google.com/macros/s/AKfycbxxraQxlvBakUFwCaInQ2dt-bQ8mwZf8qgQrfHqTTITKzlHQO7zB_yYaASoxe2oyao/exec",
